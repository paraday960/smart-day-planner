...
این فایل برای فاز پایدارسازی ساخته شده است.

> وضعیت فعلی: بیلدهای CI (Flutter CI و Android Release Build) با موفقیت اجرا شده‌اند
> و پوشهٔ `android/` حالا در ریپو نسخه‌دار است (Manifest کامل + jniLibs). با این حال،
> هر تغییر جدید باید پیش از انتشار روی دستگاه واقعی تست شود.
