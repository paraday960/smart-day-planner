...
import 'package:smart_day_planner/presentation/dashboard/dashboard_tab.dart';
...
void main() {
  testWidgets('DashboardTab renders with provider overrides', (tester) async {
